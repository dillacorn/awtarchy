...
function AwtarchyYaziContextMenu:show(kind, x, y)
    self._kind = kind
    self._x = x
    self._y = y
    self._visible = true
...
function AwtarchyYaziContextMenu:actions()
    return self._kind == "background" and AwtarchyYaziFolderActions or AwtarchyYaziItemActions
end
...
function Entity:click(event, up)
    ...
    if event.is_right then
        AwtarchyYaziContextMenu:show("item", event.x, event.y)
