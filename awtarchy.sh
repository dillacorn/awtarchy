...
declare -a PKG_GROUPS=(
  ...
  "Terminal Apps:nano micro fastfetch btop htop curl passt wget git dos2unix brightnessctl ipcalc cmatrix asciiquarium figlet termdown espeak-ng cava man-db man-pages unzip xarchiver ncdu ddcutil scx-scheds scx-tools"
