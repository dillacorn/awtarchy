...
# Entry-transition presentation is owned by LockTransitionLayer; LockScene uses
# its running state only to gate presentation, while PAM/input ownership remains
# in LockSurface. Only after the short unlock fade may the shell release WlSessionLock.
