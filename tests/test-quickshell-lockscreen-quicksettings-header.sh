...
if grep -Fq -- 'Hide Quickshell Lock Settings Before Lock Capture' "$QUICK"; then
    fail 'retired lock-capture hide toggle remains in Quick Settings'
fi

printf 'PASS: Lockscreen Quick Settings header alignment contracts\n'
